...
import { SellerLoginMethod } from '../../../store/actions'
...
const SellerLogin = ({ navigation }) => {
  ...
  return loader ? <Loader /> : (
    <ImageBackground source={require('../../../../assets/grocery.jpg')} blurRadius={150} style={{ flex: 1, justifyContent: 'center' }}>
      ...
      <Text style={{ fontSize: 14, color: 'white', textAlign: 'center', fontWeight: '400', marginBottom: 50 }}>
        ...
        Join our platform to connect with local customers and boost{'\n'}
        your sales while  we handle the rest.Partner with us today{'\n'}
        and reap the
      ...
      <Formik
        ...
        onSubmit={values => {
          dispatch(SellerLoginMethod({ values, navigation }));
        }
        }>
        {({ handleChange, handleBlur, handleSubmit, values,
          ...
          <View style={{ padding: 20, gap: 20 }}>
            ...
            <Button
              ...
              title={'Login'} />
            <Button onPress={() => { navigation.navigate('sellerregister') }} title={'Register'} />
          </View>
        )}
      </Formik>
    </ImageBackground>
